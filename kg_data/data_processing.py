...
def col_to_dic():
    ...
    data = pd.read_csv(getpath + "/computer_cate.csv", encoding='gbk')
    data_dict = {}
...
def get_json_data():
    # 将raw_data/computer.csv的数据转换成data link的json格式以便前端展示
    with open("../raw_data/computer.csv", encoding='gbk') as f:
